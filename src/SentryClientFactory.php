...
{
    private const SDK_IDENTIFIER = \Sentry\Client::SDK_IDENTIFIER . ' - typo3';
    private const SDK_VERSION = \Sentry\Client::SDK_VERSION;
    ...
    public function createClient(): ClientInterface
    {
        ...
        $defaultOptions = [
            ...
            'ignore_exceptions' => [],
            'environment' => $_SERVER['SENTRY_ENVIRONMENT'] ?? $GLOBALS['TYPO3_CONF_VARS']['SYS']['environment'] ?? str_replace('/',
